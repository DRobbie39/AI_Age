...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Admin__719FE4E8A6433D28");

            entity.ToTable("Admin");

            entity.HasIndex(e => e.Username, "UQ__Admin__536C85E446FFF3F6").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Admin__A9D10534321CF621").IsUnique();
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__ArticleC__19093A2BADB22766");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__ArticleC__C3B4DFAA79339817");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3A4876BBFD");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCACEA7541CD");

            entity.HasIndex(e => e.Username, "UQ__Users__536C85E40F3D7E66").IsUnique();
        ...
        {
            entity.HasKey(e => e.PostId).HasName("PK__UserPost__AA126038C5E44F4A");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__UserPost__19093A2B361E1FCF");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__UserPost__C3B4DFAADF28B183");
        ...
        {
            entity.HasKey(e => e.VideoId).HasName("PK__VideoArt__BAE5124AB0CC0F9C");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__VideoArt__19093A2B8F2C616D");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__VideoArt__C3B4DFAAF41C2BC6");
